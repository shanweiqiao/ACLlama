...
output_tag="../ACLlama_output/contrastive_captiondata_all_smalllr_after_stage2_allloss_lbmproj_textrealmask"
...
cmd="torchrun
    ...
    --master_port 6601
    finetune_acllama_encoder_stage2.py
    --audio_model_name_or_path "/data/s50042884/huggingface_model/whisper-large-v3"
    --text_model_name_or_path "/data/s50042884/my_code/ACLlama_output/ACLlama_encoder_chatllm_contrastive_lbmproj_testproj"
