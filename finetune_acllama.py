...
def train():
    ...
    if training_args.use_lora:
        ...
        modules_to_save = ["mm_projector1","translation_decoder","out_norm","lbm"]
        ...
        # """
        # pretrained_model_path = "/data/s50042884/my_code/audio_pretrain/ACLlama_output/ACLlama_encoder_finetune_contrastive_loss_audio_caption_large_batch_after_stage1_fix_text_emb/checkpoint-400"
    ...
    with torch.autocast("cuda"):
        # trainer.train(resume_from_checkpoint="/data/s50042884/my_code/audio_pretrain/ACLlama_zhang/ACLlama_output/ACLlama_encoder_stage1/checkpoint-1200")
        trainer.train()
    trainer.save_state()
