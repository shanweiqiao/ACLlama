...
# output_tag="../ACLlama_output/ACLlama_encoder_stage1_chatllm"
# output_tag="../ACLlama_output/ACLlama_encoder_stage2_base_chatllm_stage1"
# output_tag="../ACLlama_output/ACLlama_encoder_stage2_base_contrastive_asr_loss_from_stage1"
output_tag="../ACLlama_output/ACLlama_encoder_stage2_base_contrastive_asr_loss_from_stage1_chatllm"
...
cmd="torchrun
    ...
    --text_model_name_or_path "../ACLlama_output/ACLlama_model_ori_zhang_chatllm"
