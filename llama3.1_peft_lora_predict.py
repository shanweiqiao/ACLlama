...
def gen_model_inputs(tokenizer, system, prompt, device, audio_placeholder_ids, begin_of_text_id, start_header_id,
    ...
    # batch 1
    input_id = []
    # print(f"system str is : {system}")
    # print(f"prompt str is : {prompt}")
    ...
    # print(f"user_input_id is : {user_input_id}")
    input_id += assistant_input_id
    # print(f"assistant_input_id is : {assistant_input_id}")
    # print(f"input_id is : {len(input_id)}")
    input_ids.append(input_id)
    # print(f"input_ids is : {len(input_ids)}")
...
def process_items(thread_id, subset, args, CONFIG, return_dict):
    ...
    #######
    pretrained_model_path = "/data/s50042884/my_code/audio_pretrain/ACLlama_zhang/ACLlama_output/ACLlama_encoder_stage2_from_contrastive_asr_loss_base_stage1/checkpoint-1370"
