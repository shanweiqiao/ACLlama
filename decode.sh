...
model_path="/data/s50042884/my_code/ACLlama_zhang/ACLlama_output/ACLlama_encoder_stage1_chatllm/"
...
python llama3.1_peft_lora_predict.py \
    ...
    --base_model_path ${model_path}"checkpoint-4110" \
    --peft_model_id ${model_path}"checkpoint-4110" \
